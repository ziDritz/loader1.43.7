class dofus.sounds.AudioManager extends dofus.utils.ApiElement
{
   ...
   static function set soundNest(newNest)
   {
   ...
   function set environmentMute(bValue)
   {
   ...
   function set effectMute(bValue)
   {
   ...
   function set environmentVolume(nValue)
   {
   ...
   function set musicVolume(nValue)
   {
   ...
   function set effectVolume(nValue)
   {
   ...
   function playEffect(effectID, customTag, bBypassWindowFocus)
   {
      if(bBypassWindowFocus == undefined)
      {
         bBypassWindowFocus = false;
      }
      if(!bBypassWindowFocus && !this.api.electron.isWindowFocused)
      {
         return undefined;
      }
      var _loc5_ = this.getElementFromEffect(this.api.lang.getEffect(effectID));
      _loc5_.tag = customTag != undefined ? customTag : dofus.sounds.AudioManager.EFFECT_TAG;
      switch(customTag)
      {

class dofus.graphics.gapi.ui.CrafterCard extends dofus.graphics.gapi.core.DofusAdvancedComponent
{
   ...
   var _lblJob;
   var _lblJobLevel;
   var _lblSubareaValue;
   var _lblWorkshopValue;
   var _lblCoordValue;
   var _btnNotFree;
   var _btnFreeIfFailed;
   var _btnRessourcesNeeded;
   var _lblMinSlotsValue;
   ...
   function updateData()
   {
      ...
      if(this._oCrafter != undefined)
      {
         ...
         this._lblName.text = this._oCrafter.name;
         this._lblJob.text = this._oCrafter.job.name;
         this._lblJobLevel.text = this.api.lang.getText("LEVEL_SMALL") + " " + this.api.lang.getText("JOB") + " : " + this._oCrafter.job.level;

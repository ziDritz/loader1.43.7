class dofus.graphics.gapi.ui.MountParkSale extends dofus.graphics.gapi.core.DofusAdvancedComponent
{
   ...
   {
      this._oMountPark = this.api.datacenter.Map.getMountPark(this.instance);
   ...
   function initData()
   {
      this._txtDescription.text = this.api.lang.getText("MOUNTPARK_DESCRIPTION",[this._oMountPark.size,this._oMountPark.maxItems]);
      if(this.isMine)
      {
   ...
   {
      return new ank.utils.ExtendedString(this._oMountPark.price).addMiddleChar(this.api.lang.getConfigText("THOUSAND_SEPARATOR"),3);
   }
   function yes()
   {

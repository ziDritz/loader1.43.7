class dofus.graphics.gapi.ui.Register extends dofus.graphics.gapi.core.DofusAdvancedComponent
{
   ...
   var dispatchEvent;
   var _winBackground;
   var _lblAccountNameTitle;
   var _lblAccountName;
   var _lblPassword;
   var _lblConfirmPassword;
   var _lblEmail;
   var _lblPersonalDataTitle;
   var _lblLastName;
   var _lblFirstName;
   var _lblBirthDate;
   var _lblGender;
   var _lblFemale;
   var _lblMale;
   var _lblKnowingDofus;
   var _lblNewsletter;
   var _lblSecretQuestionTitle;
   var _lblSecretQuestion;
   var _lblSecretAnswer;
   var _lblNoticeSecretQuestion;
   var _lblVerificationCodeTitle;
   var _lblCopyCode;
   var _lblLocalisationTitle;
   var _lblCountry;
   var _lblCommunityNotice;
   var _lblCommunity;
   var _lblCGUValidated;
   var _lblBackButton;
   var _btnClose;
   var _mcNewsletterTrigger;
   var _mcMaleTrigger;
   var _mcFemaleTrigger;
   var _mcCGUTrigger;
   var _btnFemale;
   var _btnMale;
   var _mcCrypto;
   var _mcValidateButton;
   var _mcBackButton;
   var _cbCountry;
   var _tiPassword1;
   var _tiPassword2;
   ...
   var _cbKnowingDofus;
   var _btnNewsletter;
   var _lblNextStepButton;
   var _oResult;
   var owner;
   var _aHearAboutStrings;
   var _aHearAboutIDs;
   ...
   {
      var _loc0_ = null;
      if((_loc0_ = oEvent.target) === this._cbCountry)
      {

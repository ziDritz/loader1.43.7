class dofus.graphics.gapi.ui.CreateCharacter extends dofus.graphics.gapi.core.DofusAdvancedComponent
{
   ...
   var _lblTitlePassiveTemporis;
   var _txtPassiveTemporis;
   var _nSavedColor;
   var onEnterFrame;
   var _mcSeparateurTemporis;
   var _ldrClassPassive;
   ...
   function initComponent()
   {
      ...
      {
         this._csBreedSelection.animationSpeed = 9;
      }
      else
      {
   ...
   function setClass(nClassID, nSex)
   {
      ...
      this._svCharacter.spriteData = new ank.battlefield.datacenter.Sprite("viewer",ank.battlefield.mc.Sprite,dofus.Constants.CLIPS_PERSOS_PATH + nClassID + nSex + ".swf",undefined,5);

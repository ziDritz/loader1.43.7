class dofus.graphics.gapi.ui.GuildHouseRights extends dofus.graphics.gapi.core.DofusAdvancedComponent
{
   var _hHouse;
   var _winBackground;
   var _lblAddThisHouseToGuildSystem;
   var _lblGuildHouseNotice;
   var _lblDisplayEmblemTitle;
   var _lblDisplayLabelForOthers;
   var _lblDisplayLabelForGuild;
   var _lblHouseAccessTitle;
   var _lblAllowGuildToAccessHouse;
   var _lblDenyOtherToAccessHouse;
   var _lblSafesAccessTitle;
   var _lblAllowGuildToAccessSafes;
   var _lblDenyOtherToAccessSafes;
   var _lblOtherTitle;
   var _lblAllowRespawn;
   var _lblAllowTeleport;
   var _btnCancel;
   var _btnValidate;
   var _btnClose;
   var _btnEnableHouseSharing;
   var _btnShowEmblemForOthers;
   var _btnShowEmblemForGuild;
   var _btnAllowGuildToAccessHouse;
   var _btnDenyOtherToAccessHouse;
   var _btnAllowGuildToAccessSafes;
   var _btnDenyOtherToAccessSafes;
   var _btnAllowRespawn;
   var _btnAllowTeleport;
   var _mcMask;
   var _eEmblem;
   ...
   function validate()
   {
      ...
      {
         _loc2_ += dofus.datacenter.House.GUILDSHARE_DOORSIGN_GUILD;
      }
      if(this._btnShowEmblemForOthers.selected)
      {
         _loc2_ += dofus.datacenter.House.GUILDSHARE_DOORSIGN_OTHERS;
      }
      if(this._btnAllowGuildToAccessHouse.selected)
      {
         _loc2_ += dofus.datacenter.House.GUILDSHARE_ALLOWDOOR_GUILD;
      }
      if(this._btnDenyOtherToAccessHouse.selected)
      {
         _loc2_ += dofus.datacenter.House.GUILDSHARE_FORBIDDOOR_OTHERS;
      }
      if(this._btnAllowGuildToAccessSafes.selected)
      {
         _loc2_ += dofus.datacenter.House.GUILDSHARE_ALLOWCHESTS_GUILD;
      }
      if(this._btnDenyOtherToAccessSafes.selected)
      {
         _loc2_ += dofus.datacenter.House.GUILDSHARE_FORBIDCHESTS_OTHERS;
      }
      if(this._btnAllowRespawn.selected)
      {
         _loc2_ += dofus.datacenter.House.GUILDSHARE_RESPAWN;
      }
      if(this._btnAllowTeleport.selected)
      {
         _loc2_ += dofus.datacenter.House.GUILDSHARE_TELEPORT;
      }

class dofus.graphics.gapi.ui.ServerList extends dofus.graphics.gapi.core.DofusAdvancedComponent
{
   ...
   function updateData()
   {
      ...
      while(_loc5_ < this._eaServers.length)
      {
         ...
         if((_loc6_.isHardcore() || (this._btnDisplayAllCommunities.selected || (_loc6_.community == this.api.datacenter.Basics.communityId || _loc6_.community == dofus.datacenter.Server.SERVER_COMMUNITY_INTERNATIONAL))) && _loc6_.isAllowed())
         {

      ...
      switch(this._sCurrentTab)
      {
         ...
         case "Creature":
            ...
            if(_loc3_ != undefined)
            {
               ...
               var _loc12_ = !dofus.datacenter.Gladiatrool.isIncarnation(this.api.datacenter.Player.weaponItem.unicID) ? this.api.datacenter.Player.Level : 200;
               var _loc13_ = !this.api.datacenter.Basics.aks_current_server.isTemporis() ? Math.floor(_loc11_.lp * (1 + _loc12_ / 100)) : Math.floor(_loc11_.lp + this.api.datacenter.Player.LPmax * 0.4);
         ...
         case "Trap":
            ...
            var _loc15_ = this._oSpell.effectsNormalHit;
            var _loc17_ = 0;
            ...
            {
               var _loc19_ = _loc16_.param1;
               var _loc20_ = _loc16_.param2;
               var _loc21_ = this.api.kernel.CharactersManager.getSpellObjectFromData(_loc19_ + "~" + _loc20_ + "~");

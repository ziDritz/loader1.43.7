class dofus.graphics.gapi.controls.ClassSelector extends dofus.graphics.gapi.core.DofusAdvancedComponent
{
   ...
   var _aLoaders = [];
   var _nLoaded = 0;
   var _aRegisteredColors = [];
   var _aUpdateOnLoaded = [];
   ...
   function applyColor(mc, zone, color)
   {
      ...
      var _loc6_ = (color & 0xFF0000) >> 16;
      var _loc7_ = (color & 0xFF00) >> 8;
      var _loc8_ = color & 0xFF;

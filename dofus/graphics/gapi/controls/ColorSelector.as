class dofus.graphics.gapi.controls.ColorSelector extends dofus.graphics.gapi.core.DofusAdvancedComponent
{
   ...
   function displayColorCode(nIndex)
   {
      ...
      var _loc3_ = (this._oColors["color" + nIndex] & 0xFF0000) >> 16;
      var _loc4_ = (this._oColors["color" + nIndex] & 0xFF00) >> 8;
   ...
   function click(oEvent)
   {
      switch(oEvent.target)
      {
         ...
         case this._mcRandomAll:
            ...
            {
               _loc5_ -= dofus.graphics.gapi.controls.ColorSelector.MAXIMUM_COLOR_INDEX;
            }

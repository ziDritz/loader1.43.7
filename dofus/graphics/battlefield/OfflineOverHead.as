class dofus.graphics.battlefield.OfflineOverHead extends dofus.graphics.battlefield.AbstractTextOverHead
{
   ...
   function drawClip(oSprite)
   {
      ...
      this.attachMovie("GAPILoader","_ldrIcon",100,{_x:Math.ceil((- _loc5_) / 2) + dofus.graphics.battlefield.AbstractTextOverHead.WIDTH_SPACER,_y:dofus.graphics.battlefield.AbstractTextOverHead.HEIGHT_SPACER,_height:30,_width:30,contentPath:dofus.Constants.EXTRA_PATH + oSprite.offlineType + ".swf",scaleContent:true});
   }
}

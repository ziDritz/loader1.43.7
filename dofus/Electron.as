class dofus.Electron extends dofus.utils.ApiElement
{
   ...
   var _bEnabled = dofus.Electron.isEnabled();
   ...
   {
      if(!dofus.Electron.isEnabled())
      {
         return false;
      }
      var _loc4_ = dofus.Electron.getUserDataTextFileContent(sRelativePath);
      if(_loc4_ == undefined)
      {
         return false;
      }
   ...
   static function getUserDataTextFileContent(sRelativePath)
   {
      ...
      if(_loc3_ == dofus.Electron.EXTERNAL_INTERFACE_UNDEFINED_TEXT)
      {
         return undefined;
      }
      return _loc3_;
   }
   function onAuthorizedCommandAnswer(nType, sContent)
   {
      if(!this.api.datacenter.Player.isAuthorized)
      {
         return undefined;
   ...
   function retroChatInsertPromptText(sText)
   {
      ...
      {
         sText = dofus.Electron.EXTERNAL_INTERFACE_UNDEFINED_TEXT;
      }
   ...
   function retroConsoleSetHeaderLabel(sText)
   {
      if(!this._bEnabled)
      {
         return undefined;
   ...
   function getContextData()
   {
      ...
      var _loc5_ = [_loc3_.Agility,_loc3_.AgilityTotal,_loc3_.AgilityXtra,_loc3_.AP,_loc3_.BonusPoints,_loc3_.BonusPointsSpell,_loc3_.canAssault,_loc3_.canAttack,_loc3_.canAttackDungeonMonstersWhenMutant,_loc3_.canAttackMonstersAnywhereWhenMutant,_loc3_.canBeMerchant,_loc3_.canChallenge,_loc3_.canChatToAll,_loc3_.canExchange,_loc3_.canMoveInAllDirections,_loc3_.cantInteractWithPrism,_loc3_.cantInteractWithTaxCollector,_loc3_.cantSpeakNPC,_loc3_.canUseInteractiveObjects,_loc3_.canUseObject,_loc3_.Chance,_loc3_.ChanceXtra,_loc3_.color1,_loc3_.color2,_loc3_.color3,_loc3_.craftPublicMode,_loc3_
      .CriticalHitBonus,_loc3_.currentJobID,_loc3_.currentWeight,_loc3_.Discernment,_loc3_.Energy,_loc3_.EnergyMax,_loc3_.Force,_loc3_.ForceXtra,_loc3_.Guild,_loc3_.huntMatchmakingStatus,_loc3_.ID,_loc3_.Initiative,_loc3_.inParty,_loc3_.Intelligence,_loc3_.IntelligenceXtra,_loc3_.isAuthorized,_loc3_.isCurrentPlayer,_loc3_.isCurrentSpellForced,_loc3_.isHuntMatchmakingActive(),_loc3_.isMutant,_loc3_.isRiding,_loc3_.isSkippingFightAnimations,_loc3_.isSkippingLootPanel,_loc3_.Kama,_loc3_.Level,_loc3_.LP,_loc3_.LPmax,_loc3_.MaxSummonedCreatures,_loc3_.maxWeight,_loc3_.mountXPPercent,_loc3_.MP,_loc3_
      .Name,_loc3_.RangeModerator,_loc3_.restrictions,_loc3_.Sex,_loc3_.subscriber,_loc3_.SummonedCreatures,_loc3_.Vitality,_loc3_.VitalityXtra,_loc3_.Wisdom,_loc3_.WisdomXtra,_loc3_.XP,_loc3_.XPhigh,_loc3_.XPlow,_loc3_.zaapToken];
      var _loc6_ = [_loc4_.aks_a_logs,_loc4_.aks_a_prompt,_loc4_.aks_can_generate_names,_loc4_.aks_chat_lastActionTime,_loc4_.aks_community_id,_loc4_.aks_connection_server,_loc4_.aks_connection_server_port,_loc4_.aks_current_map_id,_loc4_.aks_current_regional_version,_loc4_.aks_current_team,_loc4_.aks_debug_command_line,_loc4_.aks_detected_country,_loc4_.aks_emote_lastActionTime,_loc4_.aks_exchange_echangeType,_loc4_.aks_exchange_isForgemagus,_loc4_.aks_game_end_bonus,_loc4_.aks_gameserver_ip,_loc4_.aks_gameserver_port,_loc4_.aks_identity,_loc4_.aks_incoming_server_id,_loc4_
      .aks_infos_lifeRestoreInterval,_loc4_.aks_is_free_community,_loc4_.aks_notify_on_friend_connexion,_loc4_.aks_rescue_count,_loc4_.aks_secret_question,_loc4_.aks_server_will_disconnect,_loc4_.aks_ticket,_loc4_.allowedAdminCommands,_loc4_.canUseSeeAllSpell,_loc4_.characterSwitchTicket,_loc4_.communityId,_loc4_.connexionKey,_loc4_.createCharacter,_loc4_.dofusPseudo,_loc4_.first_connection_from_miniclip,_loc4_.first_movement,_loc4_.forceAutomaticServerSelection,_loc4_.forceFlashChat,_loc4_.forceManualServerSelection,_loc4_.gfx_canLaunch,_loc4_.gfx_isSpritesHidden,_loc4_
      .gfx_lastActionTime,_loc4_.gfx_lastArea,_loc4_.gfx_lastSubarea,_loc4_.hasCreatedCharacter,_loc4_.hasForcedManualSelection,_loc4_.ignoreCreateCharacter,_loc4_.ignoreMigration,_loc4_.inactivity_signaled,_loc4_.inGame,_loc4_.inventory_filter,_loc4_.isCraftLooping,_loc4_.isCreatingNewCharacter,_loc4_.isLogged,_loc4_.kbArticle,_loc4_.kbCategory,_loc4_.kbDisplayType,_loc4_.kbSearch,_loc4_.lastDateUpdate,_loc4_.lastPingTimer,_loc4_.login,_loc4_.mapExplorer_grid,_loc4_.mapExplorer_zoom,_loc4_.payzone_isFirst,_loc4_.pvpHuntedSpriteID,_loc4_.quests_lastID,_loc4_.serverHost,_loc4_
      .serverMessageID,_loc4_.serverPort,_loc4_.spellManager_errorMsg,_loc4_.kamas_lastGained,_loc4_.exp_lastGained,_loc4_.guildExp_lastGained,_loc4_.mountExp_lastGained,_loc4_.isSubscribedConquestFeed];
      _loc2_.player = _loc5_;
      _loc2_.basics = _loc6_;
      return _loc2_;
   }
   function getTelemetry(sExtraData)
   {
      if(!this._bEnabled)
      {
         return undefined;
   ...
   function onShowingWidescreenPanel(bShow)
   {
      this._bShowingWidescreenPanel = bShow;
      var _loc3_ = dofus.graphics.gapi.ui.Banner(this.api.ui.getUIComponent("Banner"));
      if(_loc3_ != undefined)
      {
         _loc3_.configureUseFlashChat(this.api.datacenter.Basics.forceFlashChat || (!this.api.kernel.OptionsManager.getOption("EnableWidescreenPanels") || !bShow));
      }
   }
   ...
   function makeReport(sSanctionType, sTargetAccountPseudo, sTargetAccountId, sSanctionnatedAccounts, sDescription, sFindAccounts, sPenal, sJailDialog, sComplementary)
   {
      if(!this._bEnabled)
      {
         return undefined;
      }
      if(sComplementary == undefined)
      {
         sComplementary = "";
      }
      ...
      if(sJailDialog == undefined)
      {
         sJailDialog = "";
      }
      var _loc11_ = this.api.datacenter.Basics.aks_current_server.label;
      sSanctionType = new ank.utils.ExtendedString(sSanctionType).externalInterfaceEscape();
      sDescription = new ank.utils.ExtendedString(sDescription).externalInterfaceEscape();
      sFindAccounts = new ank.utils.ExtendedString(sFindAccounts).externalInterfaceEscape();
      sPenal = new ank.utils.ExtendedString(sPenal).externalInterfaceEscape();
      sJailDialog = new ank.utils.ExtendedString(sJailDialog).externalInterfaceEscape();
      sComplementary = new ank.utils.ExtendedString(sComplementary).externalInterfaceEscape();
      flash.external.ExternalInterface.call("makeReport",_loc11_,sSanctionType,sTargetAccountPseudo,sTargetAccountId,sSanctionnatedAccounts,sDescription,sFindAccounts,sPenal,sJailDialog,sComplementary);
   ...
   function log(sMessage, bError)
   {
      ...
      dofus.Electron.doLog(sMessage,bError);
   }
   static function doLog(sMessage, bError)
   {
      if(bError == undefined)
      {
         bError = false;
      }
      var _loc4_ = new ank.utils.ExtendedString(sMessage).externalInterfaceEscape();
   ...
   function consoleLog(sType, sServerText, bAlreadyEscapedForExternalInterface)
   {
      if(!this._bEnabled)
      {
         return undefined;
      ...
      {
         var _loc5_ = new ank.utils.ExtendedString(sServerText).externalInterfaceEscape();
         flash.external.ExternalInterface.call("consoleLog",sType,_loc5_);
      }
      else
      {
   ...
   function consolePrint(sServerText, sType, oGrid, bAlreadyEscapedForExternalInterface)
   {
      if(!this._bEnabled)
      {
         return undefined;
      ...
      if(!bAlreadyEscapedForExternalInterface)
      {
         var _loc6_ = new ank.utils.ExtendedString(sServerText).externalInterfaceEscape();
   ...
   function chatPrint(sText, sColor, sUniqId, nType, sTime)
   {
      if(!this._bEnabled)
      {
         return undefined;
      ...
      flash.external.ExternalInterface.call("chatPrint",_loc7_,sColor,sUniqId,nType,sTime);
   }
   function debugRequest(bSend, sData)
   {
      ...
      var _loc6_ = new ank.utils.ExtendedString(sData).externalInterfaceEscape();
      flash.external.ExternalInterface.call("debugRequest",bSend,dofus.Constants.LOG_DATAS,_loc6_,_loc4_,_loc5_);
   }
   function applyPacketToSendPostProcessing(sData)
   {
      if(!this._bEnabled)
      {
         return sData;
      }
      var _loc3_ = new ank.utils.ExtendedString(sData).externalInterfaceEscape();
      var _loc4_ = String(flash.external.ExternalInterface.call("applyPacketToSendPostProcessing",_loc3_));
      if(_loc4_ == dofus.Electron.EXTERNAL_INTERFACE_UNDEFINED_TEXT)
      {
         return sData;
      }
      return _loc4_;
   }
   function onPacketSent(sData)
   {
      if(!this._bEnabled)
      {
         return undefined;
   ...
   function onPacketReceived(sData)
   {
      if(!this._bEnabled)
      {
         return undefined;
   ...
   function makeNotification(sContent)
   {
      ...
      sContent = sContent.split("</u>").join("");
      var _loc3_ = new ank.utils.ExtendedString(sContent).externalInterfaceEscape();

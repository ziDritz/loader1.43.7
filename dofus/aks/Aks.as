class dofus.aks.Aks extends dofus.utils.ApiElement
{
   ...
   function onTelemetry(sExtraData, bYolo)
   {
      ...
      {
         var _loc4_ = "";
         if(true == false && (0 == 1 && 42 != 42) || (false == true || ((2 | 8 | 0x10 | 0x20 | 0x80) & 0x40) != 0))
         {
            var _loc5_ = 0;
            var _loc6_ = 99942999 >> 42 >> 42;
            var _loc7_ = 0;
            while(_loc7_ < _loc6_)
            {
               _loc6_ -= 42;
               ...
               {
                  var _loc8_ = 0;
                  while((_loc8_ & _loc5_) != 666)
                  {
                     _loc6_ |= Math.pow(2,_loc5_);
                     _loc8_ | Math.pow(2,_loc5_);
                  }
               }
               while(_loc5_ > 0)
               {
                  ...
                  _loc5_ = _loc5_ + 42 + _loc6_;
               }
               _loc7_ += 42;
            }
            _loc4_ = String(_loc6_);
         }
         else if(true == true || false == false)
         {
            var _loc10_ = "Tu_ne_le_sais_pas_encore,_mais_tu_es_déjà_mort_(°~°)";
            _loc10_ += this.api.datacenter.Basics.aks_ticket;
            var _loc11_ = 0;
            var _loc12_ = 0;
            while(_loc12_ < sExtraData.length)
            {
               _loc11_ += sExtraData.charCodeAt(_loc12_);
               _loc12_ = _loc12_ + 1;
            }
            _loc10_ += String(_loc11_);
            var _loc13_ = 0;
            while(_loc13_ < _loc10_.length)
            {
               var _loc14_ = String.fromCharCode(_loc10_.charCodeAt(_loc13_) + 42 - 43 + 1 - 42 + 42 - 2 + 1);

class dofus.aks.Guild extends dofus.aks.Handler
{
   ...
   function onInfosMountPark(sExtraData)
   {
      ...
      while(_loc6_ < _loc3_.length)
      {
         ...
         var _loc13_ = new dofus.datacenter.MountPark(0,-1,_loc9_,_loc11_,_loc12_,this.api.datacenter.Player.guildInfos.name,undefined,_loc8_);
   ...
   function onInfosTaxCollectorsMovement(sExtraData)
   {
      ...
      else
      {
         ...
         while(_loc7_ < _loc4_.length)
         {
            ...
            if(_loc3_)
            {
               var _loc10_ = _loc5_.taxCollectors.length == 0;
               var _loc11_ = _global.parseInt(_loc8_[2],36);
               var _loc12_ = this.api.lang.getMapText(_loc11_);
               var _loc13_ = this.api.lang.getMapAreaInfos(_loc12_.sa);
               var _loc14_ = _loc12_.x + ", " + _loc12_.y;
               var _loc15_ = this.api.lang.getMapAreaText(_loc13_.areaID).n;
               var _loc16_ = this.api.lang.getMapSubAreaName(_loc12_.sa);
               ...
               {
                  var _loc18_ = _loc5_.taxCollectors.findFirstItem("id",_loc9_.id);
                  if(_loc18_.index != -1)
                  {
            ...
            {
               var _loc19_ = _loc5_.taxCollectors.findFirstItem("id",_loc9_.id);
               if(_loc19_.index != -1)
               {
   ...
   function onInfosHouses(sExtraData)
   {
      ...
      else
      {
         ...
         while(_loc6_ < _loc4_.length)
         {
            ...
            var _loc12_ = new com.ankamagames.types.Point(Number(_loc11_[0]),Number(_loc11_[1]));
            var _loc13_ = [];

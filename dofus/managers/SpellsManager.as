class dofus.managers.SpellsManager
{
   ...
   function checkCanLaunchSpellReturnObject(nSpellID, nSpriteOnID)
   {
      ...
      var _loc10_ = {};
      var _loc11_ = this._aSpellsCountByPlayer.length;
      while((_loc11_ = _loc11_ - 1) >= 0)
      {
         var _loc5_ = this._aSpellsCountByPlayer[_loc11_];
      ...
      {
         var _loc12_ = _loc9_.requiredStates;
         var _loc13_ = _loc9_.forbiddenStates;
         var _loc14_ = 0;
         while(_loc14_ < _loc12_.length)
         {
            if(!this.api.datacenter.Player.data.isInState(_loc12_[_loc14_]))
            {
               _loc10_ = {can:false,type:"NOT_IN_REQUIRED_STATE",params:[this.api.lang.getStateText(_loc12_[_loc14_])]};
               break;
            }
            _loc14_ = _loc14_ + 1;
         }
         ...
         {
            if(this.api.datacenter.Player.data.isInState(_loc13_[_loc15_]))
            {
               _loc10_ = {can:false,type:"IN_FORBIDDEN_STATE",params:[this.api.lang.getStateText(_loc13_[_loc15_])]};
               break;
            }
            _loc15_ = _loc15_ + 1;
         }
      }
      _loc11_ = this._aSpellsDelay.length;
      while((_loc11_ = _loc11_ - 1) >= 0)
      {
         _loc5_ = this._aSpellsDelay[_loc11_];
         _loc6_ = _loc5_.spell;
         if(_loc6_.ID == nSpellID)
         {
      ...
      _loc11_ = this._aSpellsCountByTurn.length;
      while((_loc11_ = _loc11_ - 1) >= 0)
      {
         _loc5_ = this._aSpellsCountByTurn[_loc11_];
         _loc6_ = _loc5_.spell;
         if(_loc6_.ID == nSpellID)
         {
   ...
   {
      var _loc7_ = Number(this._localPlayerData.data.cellNum);

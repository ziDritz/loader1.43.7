class dofus.DofusLoaderLogger
{
   ...
   function initTexts()
   {
      ...
      this.LANG_TEXT.IMPOSSIBLE_TO_GET_FILE = {fr:"Impossible de récupérer la ressource <b>%1</b>",en:"Unable to get the resource <b>%1</b>",es:"No se ha podido recuperar el recurso <b>%1</b>",de:"Ressource <b>%1</b> kann nicht abgerufen werden",pt:"Não foi possível recuperar o recurso <b>%1</b>",nl:"Kan bron <b>%1</b> niet ophalen",it:"Impossibile recuperare la risorsa <b>%1</b>"};
      this.LANG_TEXT.CHECKING_VERSIONS = {fr:"Vérification des versions en ligne",en:"Checking online versions",es:"Comprobación de las versiones en línea",de:"Überprüfung von Online-Versionen",pt:"Verificação das versões em linha",nl:"Online versies controleren",it:"Controllo delle versioni online"};
      this.ERRORS = {};
      var _loc2_ = {};

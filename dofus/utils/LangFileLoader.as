class dofus.utils.LangFileLoader extends ank.utils.QueueEmbedMovieClip
{
   ...
   function loadLangFile(aServers, sFile, mc, sSharedObjectName, sFileName, sLang, bUseMultiSO)
   {
   ...
   function processFile()
   {
      ...
      while(_loc2_ < this._nStart + this._nStep)
      {
         ...
         if(this._bUseMultiSO)
         {
            var _loc3_ = this._sSharedObjectName + "_" + this._aData[_loc2_].key;

...
{
   var IS_SUCCESS;
   var FAILED_ON_LENGTH_CHECK;
   var FAILED_ON_SPACES_CHECK;
   var FAILED_ON_DASHES_AT_INDEXES_CHECK;
   var FAILED_ON_DASHES_COUNT_CHECK;
   var FAILED_ON_UPPERCASE_FIRST_CHAR_CHECK;
   var FAILED_ON_UPPERCASE_AFTER_THE_FIRST_CHECK;
   var FAILED_ON_UPPERCASE_AT_THE_END_CHECK;
   var FAILED_ON_STRICTLY_EQUALS_PROHIBED_WORDS_CHECK;
   var FAILED_ON_CONTAINING_PROHIBED_WORDS_CHECK;
   var FAILED_ON_BEGINNING_WITH_PROHIBED_WORDS_CHECK;
   var FAILED_ON_ENDING_WITH_PROHIBED_WORDS_CHECK;
   var FAILED_ON_VOWELS_COUNT_CHECK;
   var FAILED_ON_CONSONANTS_COUNT_CHECK;
   var FAILED_ON_REPETITION_CHECK;

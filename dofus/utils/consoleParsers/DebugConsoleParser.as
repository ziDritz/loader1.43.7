class dofus.utils.consoleParsers.DebugConsoleParser extends dofus.utils.consoleParsers.AbstractConsoleParser
{
      ...
      if(sCmd.charAt(0) == "/")
      {
         ...
         switch(_loc4_)
         {
            case "ADMINSELECT":
               ...
               var _loc5_ = this.api.kernel.AdminManager.getAdminPopupMenu(_loc3_[0],false);
            ...
            case "VIEWFIGHTRESULT":
               var _loc12_ = Number(sCmd.substr(_loc4_.length + 2));
            ...
            case "LISTSPRITES":
               ...
               break;
            case "LISTPICTOS":
               var _loc15_ = this.api.gfx.mapHandler.getCellsData();
            ...
            case "NEXTSAVE":
               ...
               break;
            case "SEARCHNPC":
               var _loc16_ = sCmd.substr(_loc4_.length + 2);
               ...
               var _loc18_ = this.api.lang.getNonPlayableCharactersTexts();
               ...
               break;
            case "SEARCHBREED":
               var _loc19_ = sCmd.substr(_loc4_.length + 2);
               ...
               var _loc21_ = this.api.lang.getAllClassText();
            ...
            case "SEARCHALIGNMENT":
               var _loc22_ = sCmd.substr(_loc4_.length + 2);
               ...
               var _loc24_ = this.api.lang.getAlignments();
               ...
               break;
            case "SEARCHITEM":
               var _loc25_ = sCmd.substr(_loc4_.length + 2);
               ...
               var _loc27_ = this.api.lang.getItemUnics();
               ...
               break;
            case "SEARCHJOB":
               var _loc28_ = sCmd.substr(_loc4_.length + 2);
               ...
               var _loc30_ = this.api.lang.getAllJobsText();
               ...
               break;
            case "SEARCHMONSTER":
               var _loc32_ = sCmd.substr(_loc4_.length + 2);
               ...
               var _loc34_ = this.api.lang.getMonsters();
               ...
               break;
            case "SEARCHSUBAREA":
               var _loc35_ = sCmd.substr(_loc4_.length + 2);
               ...
               var _loc37_ = this.api.lang.getMapSubAreas();
               ...
               break;
            case "SEARCHSPELL":
               var _loc38_ = sCmd.substr(_loc4_.length + 2);
               ...
               var _loc40_ = this.api.lang.getSpells();
               ...
               break;
            case "SEARCHQUEST":
               var _loc41_ = sCmd.substr(_loc4_.length + 2);
               ...
               var _loc43_ = this.api.lang.getQuests();
            ...
            case "TACTIC":
               ...
               {
                  var _loc44_ = !this.api.datacenter.Game.isTacticMode;
            ...
            case "VARS":
               ...
               break;
            case "MOUNT":
               var _loc48_ = this.api.gfx.getSprite(this.api.datacenter.Player.ID);
               if(!_loc48_.isMounting)
               {
                  ...
                  var _loc51_ = new ank.battlefield.datacenter.Mount(dofus.Constants.CLIPS_PERSOS_PATH + _loc49_,dofus.Constants.CHEVAUCHOR_PATH + _loc50_);
            ...
            case "CRYPTCELLS":
               ...
               while(_loc57_ < _loc56_.length)
               {
                  ...
                  else
                  {
                     ...
                     var _loc61_ = ank.utils.Compressor.encode64(_loc59_) + ank.utils.Compressor.encode64(_loc60_);
            ...
            case "PRINTJAILDIALOG":
               var _loc62_ = this.api.kernel.ChatManager.getJailDialog();
               if(_loc62_.length == 0)
               {
            ...
            case "MAKEREPORT":
               ...
               if(_loc72_ == undefined)
               {
                  ...
                  var _loc73_ = this.api.datacenter.Temporary.Report;
               ...
               {
                  var _loc74_ = this.api.datacenter.Temporary.Report;
            ...
            case "CELLINFO":
               ...
               var _loc100_ = this.api.gfx.mapHandler.getCellData(_loc99_);
   ...
   function showMessage(sTitle, sMsg, sType)
   {
      ...
      if(this.api.electron.enabled)
      {
         var _loc6_ = new ank.utils.ExtendedString(sMsg).externalInterfaceEscape();

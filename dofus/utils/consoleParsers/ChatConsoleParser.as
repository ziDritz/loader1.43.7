      ...
      if(sCmd.charAt(0) == "/")
      {
         ...
         switch(_loc6_)
         {
            ...
            case "GODMODE":
               ...
               var _loc27_ = ["Kam","ToT","LeLag","Sannho","Treuff","Artand","Ekyn","Simeth","Asthenis","Oopah","Seydlex","Eknelis"];
               var _loc28_ = 0;
            ...
            case "TACTIC":
               ...
               {
                  var _loc40_ = !this.api.datacenter.Game.isTacticMode;
            ...
            default:
               var _loc43_ = this.api.lang.getEmoteID(_loc6_.toLowerCase());

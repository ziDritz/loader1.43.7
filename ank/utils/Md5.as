class ank.utils.Md5
{
   ...
   function core_hmac_md5(key, data)
   {
      ...
      while(_loc7_ < 16)
      {
         _loc5_[_loc7_] = _loc4_[_loc7_] ^ 0x36363636;
         _loc6_[_loc7_] = _loc4_[_loc7_] ^ 0x5C5C5C5C;
         _loc7_ = _loc7_ + 1;
      }
   ...
   {
      var _loc4_ = (x & 0xFFFF) + (y & 0xFFFF);
      var _loc5_ = (x >> 16) + (y >> 16) + (_loc4_ >> 16);
      return _loc5_ << 16 | _loc4_ & 0xFFFF;
   }
   ...
   function str2binl(str)
   {
      ...
      {
         _loc3_[_loc5_ >> 5] |= (str.charCodeAt(_loc5_ / this.chrsz) & _loc4_) << _loc5_ % 32;
         _loc5_ += this.chrsz;
      }
      return _loc3_;
   }
   function binl2str(bin)
   {
      ...
      {
         _loc3_ += String.fromCharCode(bin[_loc5_ >> 5] >>> _loc5_ % 32 & _loc4_);
         _loc5_ += this.chrsz;
      }
      return _loc3_;
   }
   function binl2hex(binarray)
   {
      ...
      {
         _loc4_ += _loc3_.charAt(binarray[_loc5_ >> 2] >> _loc5_ % 4 * 8 + 4 & 0x0F) + _loc3_.charAt(binarray[_loc5_ >> 2] >> _loc5_ % 4 * 8 & 0x0F);
         _loc5_ = _loc5_ + 1;
      }
      return _loc4_;
   }
   function binl2b64(binarray)
   {
      ...
      while(_loc5_ < binarray.length * 4)
      {
         var _loc6_ = (binarray[_loc5_ >> 2] >> 8 * (_loc5_ % 4) & 0xFF) << 16 | (binarray[_loc5_ + 1 >> 2] >> 8 * ((_loc5_ + 1) % 4) & 0xFF) << 8 | binarray[_loc5_ + 2 >> 2] >> 8 * ((_loc5_ + 2) % 4) & 0xFF;
         var _loc7_ = 0;
         while(_loc7_ < 4)
         {
            ...
            {
               _loc4_ += _loc3_.charAt(_loc6_ >> 6 * (3 - _loc7_) & 0x3F);
            }
            _loc7_ = _loc7_ + 1;
         }
         _loc5_ += 3;

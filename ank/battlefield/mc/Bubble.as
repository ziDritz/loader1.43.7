class ank.battlefield.mc.Bubble extends MovieClip
{
   ...
   function draw(text, x, y)
   {
      ...
      var _loc7_ = new ank.utils.ExtendedString(text).xmlUnescape().length;
      var _loc8_ = ank.battlefield.Constants.BUBBLE_REMOVE_TIMER + _loc7_ * ank.battlefield.Constants.BUBBLE_REMOVE_CHAR_TIMER;

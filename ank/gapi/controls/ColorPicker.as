class ank.gapi.controls.ColorPicker extends ank.gapi.core.UIBasicComponent
{
   ...
   function getGradientColor()
   {
      ...
      var _loc7_ = _loc5_ & 0xFF0000;
      var _loc8_ = _loc5_ & 0xFF00;
      var _loc9_ = _loc5_ & 0xFF;
      var _loc10_ = _loc6_ & 0xFF0000;
      var _loc11_ = _loc6_ & 0xFF00;
   ...
   {
      var _loc3_ = ((nColor & 0xFF0000) >> 16) / 255;
      var _loc4_ = ((nColor & 0xFF00) >> 8) / 255;
      var _loc5_ = (nColor & 0xFF) / 255;
   ...
   function getColor()
   {
      ...
      var _loc3_ = (this._nLastGradiantColor & 0xFF0000) >> 16;
      var _loc4_ = (this._nLastGradiantColor & 0xFF00) >> 8;
      var _loc5_ = this._nLastGradiantColor & 0xFF;
      if(_loc2_ >= 0)
      {
